...
Working demo()long time of oading caused by the build option each time app starts(save or create production version for your purposes)

https://venbestfilter.herokuapp.com
